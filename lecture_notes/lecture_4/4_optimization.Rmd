...
.hi-blue[Write out a golden search algorithm]
...
the most commonly used one is .hi-blue[Nelder-Mead (NM)]
...
.hi-blue[Problem:] most algorithms are *local* minimizers that find a point $x^*$  
...
<div align="center">
  <img src="figures/steepest_descent.png" height=300>
</div>
...
The .hi-blue[scaling] of a problem matters for optimization performance

--

A problem is .hi-blue[poorly scaled] if changes to $x$ in a certain direction  
