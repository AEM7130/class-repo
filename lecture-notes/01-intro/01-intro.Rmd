...
1. Everything we use in the course will be .hi[freely available] and posted to the course GitHub (details next week on how to use Git)
...
- Final project proposal: March 17
- Final project paper: May 19
...
1st year PhD core: everything is typically analytically tractable
...
.hi[Big O notation] describes the limiting behavior of a function when the argument tends towards a particular value or infinity
...
.hi[matrix inversion], most algorithms (e.g. LU decomposition) solve in polynomial time
