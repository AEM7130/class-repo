...
We have our three equilibrium conditions in changes

Along with the labor transition $L_{jt+1} = \sum_{i \in N} \pi_{ijt} L_{it}$, we can then solve for the dynamic equilibrium of the economy given some sequence of .hi[changes] in productivity $\dot{A}_{jt+1}$
...
$$L_{jt+1} = \sum_{i \in N} \pi_{ijt} L_{it}$$
