...
- worker location choice (Diamond, 2016) [.hi[space + BLP!]]
...
It is a version of the canonical Eaton and Kortum (2002) Ricardian trade model
...
1. Develop the static model (why is it called a gravity model?)
...
Each industry produces a continuum of varieties (more later) such that $C_i$ is a .pink[constant elasticity of substitution] aggregate of the varieties with elasticity $\sigma$
...
With a bit of math we can solve for the .pink[ideal price index:]
