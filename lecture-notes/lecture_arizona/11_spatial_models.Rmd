...
3. Show how to use .blue[exact hat algebra] to simulate counterfactuals without data on time-invariant exogenous variables (Dekle et al. 2008)
...
First we need to define a new variable, .pink[expenditure shares:] the share of total expenditures on products from location $j$
